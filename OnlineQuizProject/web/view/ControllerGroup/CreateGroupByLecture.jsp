...
<html>
    <head>
        ...
        <style>
            *{
            ...
            .container {
                padding: 20px; /* Adjust container padding for spacing */
            }

            .form-group {
                margin-bottom: 20px; /* Adjust form group margin for spacing */
            }

            /* Additional Bootstrap classes for styling the anchor tag */
            .view-link {
    ...
    <body>
        ...
        <div class="container">
            <a href="<%=request.getContextPath()%>/GroupOwned" class="view-link">View List group owned</a> <br/>
            <form action="CreateGroup" method="POST" class="needs-validation" novalidate=> 
