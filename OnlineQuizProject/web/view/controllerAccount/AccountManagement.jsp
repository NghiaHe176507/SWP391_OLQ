...
<html lang="en">
    ...
    <head>
        ...
        <script>
            function deleteAccount(id)
            {
                ...
                if (conf) {
                    var deleteUrl = '<%=request.getContextPath()%>/admin/account-management/delete-account?accountId=' + id;
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="left-side">
                <a href="<%=request.getContextPath()%>/admin/account-management/create-account" id="toggleFormLink " class="btn btn-success mb-3">Create</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${requestScope.listRoleFeatureByListAccount.get(requestScope.listAccountWithInfo.indexOf(accountInfo)).getRole().getRoleId() != 1}">
                                            <a href="<%=request.getContextPath()%>/admin/account-management/update-account?accountId=${accountInfo.account.accountId}" class="btn btn-warning btn-sm">Edit</a>
