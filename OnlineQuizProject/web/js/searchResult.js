...
document.addEventListener("DOMContentLoaded", function () {
    var showAllBtn = document.getElementById("showAllBtnGroup");
    var showLessBtn = document.getElementById("showLessBtnGroup");
    var topicInfos = document.querySelectorAll(".group-info");
